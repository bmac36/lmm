...
$email_address = 'littlemusicmakerz@gmail.com';
//$email_address = 'bmac.creative@icloud.com';
// add your company name here
$company_name = 'Little Music Makerz presents Kindermusik';
...
$success_message->message   = 'Thank you! Your request for a Party Booking has been sent';
...
$mail_error_message->message   = 'Sorry your request was not sent - please try again later';
...
if (!empty($fields)) {
    ...
    if (empty($returnVal->messages)) {
        ...
        $subject = 'I would like to book a party with ' . $company_name .;
        $body = stripslashes(safe($fields['message']));

        $content = $email . " sent you a message from your Book a Party or Demo form:\r\n\n";
        $content .= "-------\n" . $body . "\r\n\n\r\n\nEmail: " . $email;
