...
$success_message->message   = 'Thanks! your request for a preview class or demo has been sent';
...
if (!empty($fields)) {
    ...
    if (empty($returnVal->messages)) {
        ...
        $content = $email . " sent you a message from your book a preview class form:\r\n\n";
        $content .= "-------\n" . $body . "\r\n\n\r\n\nEmail: " . $email;
