...
$success_message->message   = 'Thanks! Your wait list request has been sent';
...
$mail_error_message->message   = 'Sorry your wait list request was not sent - please try again later';
...
if (!empty($fields)) {
    ...
    if (empty($returnVal->messages)) {
        ...
        $subject = 'Wait List Request for ' . $company_name . ' class';
        $body = stripslashes(safe($fields['message']));

        $content = $email . " sent you a wait list request from your Wait List Request form:\r\n\n";
        $content .= "-------\n" . $body . "\r\n\n\r\n\nEmail: " . $email;
